<template>
  <div class="w-full py-5 px-2 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
    <div class="flex flex-col items-center">
      ...
      <!-- 介绍语 -->
      <span class="mb-6 text-sm text-gray-500 dark:text-gray-400" data-tooltip-placement="bottom"
            data-tooltip-target="introduction-tooltip-bottom">{{ blogSettingsStore.blogSettings.introduction }}</span>
      <div id="introduction-tooltip-bottom" class="absolute z-10 invisible inline-block px-3 py-2 text-xs font-medium text-white bg-gray-900 rounded shadow-sm opacity-0 tooltip dark:bg-gray-700"
           role="tooltip">
        介绍语
      ...
      <div class="flex justify-center gap-2">
        ...
        <svg v-if="blogSettingsStore.blogSettings.githubHomepage"
             class="hover:scale-110 icon mt-5 w-7 h-7" data-tooltip-placement="bottom"
             data-tooltip-target="github-tooltip-bottom" height="200"
             p-id="1447" t="1698029949662" version="1.1"
             viewBox="0 0 1024 1024"
             width="200" xmlns="http://www.w3.org/2000/svg" @click="jump(blogSettingsStore.blogSettings.githubHomepage)">
        ...
        <div id="github-tooltip-bottom" class="absolute z-10 invisible inline-block px-3 py-2 text-xs font-medium text-white bg-gray-900 rounded shadow-sm opacity-0 tooltip dark:bg-gray-700"
             role="tooltip">
          我的 GitHub
          <div class="tooltip-arrow" data-popper-arrow></div>
        </div>
        ...
        <svg v-if="blogSettingsStore.blogSettings.giteeHomepage"
             class="hover:scale-110 icon mt-5 w-7 h-7" data-tooltip-placement="bottom"
             data-tooltip-target="gitee-tooltip-bottom" height="200"
             p-id="2438" t="1698030969736" version="1.1"
             viewBox="0 0 1024 1024"
             width="200" xmlns="http://www.w3.org/2000/svg" @click="jump(blogSettingsStore.blogSettings.giteeHomepage)">
          <path
        ...
        <div id="gitee-tooltip-bottom" class="absolute z-10 invisible inline-block px-3 py-2 text-xs font-medium text-white bg-gray-900 rounded shadow-sm opacity-0 tooltip dark:bg-gray-700"
             role="tooltip">
          我的 Gitee
          <div class="tooltip-arrow" data-popper-arrow></div>
        </div>
        ...
        <svg v-if="blogSettingsStore.blogSettings.zhihuHomepage"
             class="hover:scale-110 icon mt-5 w-7 h-7" data-tooltip-placement="bottom"
             data-tooltip-target="zhihu-tooltip-bottom" height="200"
             p-id="3419" t="1698031258903" version="1.1"
             viewBox="0 0 1024 1024"
             width="200" xmlns="http://www.w3.org/2000/svg" @click="jump(blogSettingsStore.blogSettings.zhihuHomepage)">
        ...
        <div id="zhihu-tooltip-bottom" class="absolute z-10 invisible inline-block px-3 py-2 text-xs rounded font-medium text-white bg-gray-900 shadow-sm opacity-0 tooltip dark:bg-gray-700"
             role="tooltip">
          我的知乎
          <div class="tooltip-arrow" data-popper-arrow></div>
        </div>
        ...
        <svg v-if="blogSettingsStore.blogSettings.csdnHomepage"
             class="hover:scale-110 icon mt-5 w-7 h-7" data-tooltip-placement="bottom"
             data-tooltip-target="csdn-tooltip-bottom" height="200"
             p-id="4386" t="1698031311586" version="1.1"
             viewBox="0 0 1024 1024"
             width="200" xmlns="http://www.w3.org/2000/svg" @click="jump(blogSettingsStore.blogSettings.csdnHomepage)">
          <path
        ...
        <div id="csdn-tooltip-bottom" class="absolute z-10 invisible inline-block px-3 py-2 text-xs rounded font-medium text-white bg-gray-900 shadow-sm opacity-0 tooltip dark:bg-gray-700"
             role="tooltip">
          我的 CSDN
          <div class="tooltip-arrow" data-popper-arrow></div>
        </div>
