<template>
  <div
    ...
    <div
      ...
      <!-- 装饰性光晕 -->
      <div
          class="absolute top-0 right-0 w-24 h-24 bg-white/20 rounded-full blur-2xl transform translate-x-1/2 -translate-y-1/2"></div>
    ...
    <div class="px-5 pb-6 relative text-center">
      ...
      <div class="flex justify-center items-center gap-3">
        <!-- GitHub -->
        <a v-if="blogSettingsStore.blogSettings.githubHomepage"
           class="social-btn group/icon"
          ...
          <svg class="w-5 h-5 fill-gray-500 group-hover/icon:fill-white dark:fill-gray-400 transition-colors"
            ...
            <!-- 隐藏原背景 -->
            <path
                d="M611.944 302.056c0-15.701 2.75-30.802 7.816-44.917a384.238 384.238 0 0 0-186.11 2.956c-74.501-50.063-93.407-71.902-107.975-39.618a136.243 136.243 0 0 0-3.961 102.287 149.515 149.515 0 0 0-39.949 104.806c0 148.743 92.139 181.875 179.961 191.61a83.898 83.898 0 0 0-25.192 51.863c-40.708 22.518-91.94 8.261-115.181-32.058a83.117 83.117 0 0 0-60.466-39.98s-38.871-0.361-2.879 23.408a102.97 102.97 0 0 1 43.912 56.906s23.398 75.279 133.531 51.863v65.913c0 10.443 13.548 42.63 102.328 42.63 71.275 0 94.913-30.385 94.913-42.987V690.485a90.052 90.052 0 0 0-26.996-72.03c83.996-9.381 173.328-40.204 179.6-176.098a164.706 164.706 0 0 1-21.129 1.365c-84.07 0-152.223-63.426-152.223-141.666z"></path>
          </svg>
        </a>
        ...
        <a v-if="blogSettingsStore.blogSettings.giteeHomepage"
           class="social-btn group/icon hover:bg-[#C71D23] hover:border-[#C71D23]"
           data-tooltip-target="gitee-tooltip"
           @click="jump(blogSettingsStore.blogSettings.giteeHomepage)">
          <svg class="w-5 h-5 fill-gray-500 group-hover/icon:fill-white dark:fill-gray-400 transition-colors"
               version="1.1" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M512 1024C229.222 1024 0 794.778 0 512S229.222 0 512 0s512 229.222 512 512-229.222 512-512 512z m259.149-568.883h-290.74a25.293 25.293 0 0 0-25.292 25.293l-0.026 63.206c0 13.952 11.315 25.293 25.267 25.293h177.024c13.978 0 25.293 11.315 25.293 25.267v12.646a75.853 75.853 0 0 1-75.853 75.853h-240.23a25.293 25.293 0 0 1-25.267-25.293V417.203a75.853 75.853 0 0 1 75.827-75.853h353.946a25.293 25.293 0 0 0 25.267-25.292l0.077-63.207a25.293 25.293 0 0 0-25.268-25.293H417.152a189.62 189.62 0 0 0-189.62 189.645V771.15c0 13.977 11.316 25.293 25.294 25.293h372.94a170.65 170.65 0 0 0 170.65-170.65V480.384a25.293 25.293 0 0 0-25.293-25.267z"></path>
          </svg>
        </a>
        ...
        <a v-if="blogSettingsStore.blogSettings.csdnHomepage"
           class="social-btn group/icon hover:bg-[#DD1700] hover:border-[#DD1700]"
...
/* 社交图标基础样式 */
.social-btn {
  @apply flex items-center justify-center w-9 h-9 rounded-full bg-gray-100 border border-transparent
  transition-all duration-300 cursor-pointer shadow-sm hover:-translate-y-1 hover:shadow-md
