  ...
  <div v-if="categories && categories.length > 0"
    ...
    <div class="flex mb-3">
      <h2 class="flex items-center font-bold text-gray-900 uppercase dark:text-white">
        <!-- 文件夹图标 -->
        <svg class="inline icon w-4 h-4 mr-2" height="200" p-id="21572" t="1698998570037"
      ...
      <a class=" bg-gray-100 flex items-center px-2.5 py-1 text-xs font-medium text-center
            ...
            dark:bg-gray-800 dark:text-white dark:border dark:border-gray-700 dark:hover:bg-gray-700 dark:hover:border-gray-700
             dark:focus:ring-gray-700" @click="router.push('/category/list')">
        <svg aria-hidden="true" class="w-[7px] h-[7px] text-gray-400 dark:text-white"
             fill="none" viewBox="0 0 8 14" xmlns="http://www.w3.org/2000/svg">
          <path d="m1 13 5.7-5.326a.909.909 0 0 0 0-1.348L1 1" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                stroke-width="2"/>
        </svg>
      </a>
