<template>
  <!-- 撑空间 -->
  <div class="top-0 left-0 right-0 z-10 h-20"/>
    ...
    <nav class="bg-white border-gray-200 border-b dark:bg-gray-900 dark:border-gray-800">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <a class="flex items-center" href="/">
          <img :src="blogSettingsStore.blogSettings.logo" alt="Weblog Logo" class="h-8 mr-3 rounded-full"/>
        ...
        <div class="flex items-center md:order-2">
          ...
          <!-- 白天黑夜切换 -->
          <button aria-checked="false" aria-label="切换深色模式" class="ml-1 mr-4 vt-switch vt-switch-appearance"
                  data-v-d401ce6f=""
                  role="switch"
                  type="button" @click="toggleDark()"><span class="vt-switch-check"><span
              class="vt-switch-icon"><!--[-->
            <!-- 太阳图标 -->
                                <svg :class="[isDark ? 'hidden' : 'block']" aria-hidden="true"
                                     class="vt-switch-appearance-sun" focusable="false" viewBox="0 0 24 24"
                                     xmlns="http://www.w3.org/2000/svg"
                                >
                                    <path
            ...
            <!-- 黑夜图标 -->
                                <svg :class="[isDark ? 'block' : 'hidden']" aria-hidden="true"
          ...
          <!-- 搜索框 -->
          <button class="mr-2 hidden outline-none md:flex items-center text-sm leading-6 text-slate-400 rounded-md
                        ring-1 ring-slate-900/10 shadow-sm py-1.5 pl-2 pr-3 hover:ring-slate-300
                        dark:bg-slate-800 dark:hover:bg-slate-700 dark:hover:ring-slate-700" type="button"
                  @click="clickSearchBtn">
            <svg aria-hidden="true" class="w-3.5 h-3.5 mr-2 text-gray-500 dark:text-gray-400"
          ...
          <!-- 登录 -->
          <div v-if="!isLogined" class="text-gray-900 ml-1 mr-1 hover:text-sky-600 dark:text-white"
        ...
        <div id="navbar-search" class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
          ...
          <!-- 移动端搜索框 -->
          <button class="relative mt-3 flex w-full md:hidden items-center text-sm leading-6 text-slate-400 rounded-md
                         ring-1 ring-slate-900/10 shadow-sm py-1.5 pl-2 pr-3 hover:ring-slate-300 dark:bg-slate-800
                         dark:highlight-white/5 dark:hover:bg-slate-700 dark:hover:ring-slate-700" type="button"
                  @click="clickSearchBtn">
            <svg aria-hidden="true" class="w-3.5 h-3.5 mr-2 text-gray-500 dark:text-gray-400"
                 fill="none" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z" stroke="currentColor" stroke-linecap="round"
          ...
          <ul
            ...
            <li>
              <a :class="[currPath === '/' ? 'text-sky-600 md:border-b-2 md:border-sky-600 dark:text-sky-500 dark:md:border-sky-600' : 'text-gray-900']"
                 aria-current="page"
            ...
            <li>
              <a :class="[currPath.startsWith('/category') ? 'text-sky-600 md:border-b-2 md:border-sky-600 dark:text-sky-500 dark:md:border-sky-600' : 'text-gray-900']"
                 class="block py-2 pl-3 pr-4 rounded md:rounded-none hover:bg-gray-100 md:hover:bg-transparent md:hover:text-sky-600 md:p-0 md:dark:hover:text-sky-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                 @click="router.push('/category/list')">分类</a>
            </li>
            <li>
              <a :class="[currPath.startsWith('/tag') ? 'text-sky-600 md:border-b-2 md:border-sky-600 dark:text-sky-500 dark:md:border-sky-600' : 'text-gray-900']"
                 class="block py-2 pl-3 pr-4 rounded md:rounded-none hover:bg-gray-100 md:hover:bg-transparent md:hover:text-sky-600 md:p-0 dark:text-white md:dark:hover:text-sky-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                 @click="router.push('/tag/list')">标签</a>
            </li>
            <li>
              <a :class="[currPath === '/archive/list' ? 'text-sky-600 md:border-b-2 md:border-sky-600 dark:text-sky-500 dark:md:border-sky-600' : 'text-gray-900']"
                 class="block py-2 pl-3 pr-4 rounded md:rounded-none hover:bg-gray-100 md:hover:bg-transparent md:hover:text-sky-600 md:p-0 dark:text-white md:dark:hover:text-sky-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                 @click="router.push('/archive/list')">归档</a>
            </li>
            <li>
              <a :class="[currPath === '/wiki/list' ? 'text-sky-600 md:border-b-2 md:border-sky-600 dark:text-sky-500 dark:md:border-sky-600' : 'text-gray-900 dark:text-white']"
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <form class="w-full mr-2">
            ...
            <div class="relative">
              <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                ...
                <svg v-else aria-hidden="true" class="w-4 h-4 text-gray-500 dark:text-gray-400"
                     fill="none" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z" stroke="currentColor" stroke-linecap="round"
          ...
          <div v-if="searchArticles && searchArticles.length > 0">
            ...
            <ol class="mt-3 divide-y divider-gray-200 dark:divide-gray-600">
              <li v-for="(article, index) in searchArticles" :key="index">
                <a class="items-center cursor-pointer block p-3 sm:flex hover:bg-gray-100 hover:rounded-lg
                                    dark:hover:bg-gray-600"
                   @click="jumpToArticleDetailPage(article.id)">
                  <img :src="article.cover" class="w-24 h-full mb-3 mr-3 rounded-lg sm:mb-0">
                  <div class="text-gray-600 dark:text-gray-400">
                    <h2 class="text-base font-normal text-gray-900 dark:text-white" v-html="article.title"></h2>
                    <span
                        class="inline-flex items-center text-xs font-normal text-gray-500 dark:text-gray-400">
                                            <svg aria-hidden="true"
                                                 class="inline w-2.5 h-2.5 mr-2 text-gray-400" fill="none"
                                                 viewBox="0 0 20 20"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path
            ...
            <!-- 分页 -->
            <div class="flex mt-7">
              <a v-if="current > 1" class="flex items-center justify-center px-3 h-8 me-3 text-xs font-medium text-gray-500 border
                ...
                <svg aria-hidden="true" class="w-3 h-3 rtl:rotate-180" fill="none"
                  ...
                  <path d="M13 5H1m0 0 4 4M1 5l4-4" stroke="currentColor" stroke-linecap="round"
                        stroke-linejoin="round" stroke-width="2"/>
                </svg>
              </a>

              <a v-if="current < pages" class="flex ml-auto items-center justify-center px-3 h-8 text-xs font-medium text-gray-500
        ...
        <div class="p-4 md:p-5 border-t text-xs flex items-center text-gray-400 dark:border-gray-600">
          ...
          <!-- 底层技术介绍 -->
          <span class="ml-auto">基于&nbsp;<a class="underline" href="https://lucene.apache.org/"
                                             target="_blank">Apache Lucene</a>&nbsp;全文检索引擎开发</span>
        </div>
      </div>
    </div>
  </div>
