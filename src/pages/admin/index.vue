    ...
    <div class="grid grid-cols-4 gap-7">
      ...
      <div class="col-span-4 md:col-span-1">
        ...
        <div
          ...
          <svg class="icon w-10 h-10" height="200" p-id="6627" t="1699865769161" version="1.1" viewBox="0 0 1024 1024"
      ...
      <div class="col-span-4 md:col-span-1">
        ...
        <div
          class="flex items-center w-full h-full px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
          <svg class="icon w-10 h-10" height="200" p-id="15660" t="1699866300645" version="1.1" viewBox="0 0 1024 1024"
            width="200" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="col-span-4 md:col-span-1">
        ...
        <div
          class="flex items-center w-full h-full px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
          <svg class="icon w-10 h-10" height="200" p-id="27760" t="1699866473165" version="1.1" viewBox="0 0 1024 1024"
            width="200" xmlns="http://www.w3.org/2000/svg">
            <path
      ...
      <div class="col-span-4 md:col-span-1">
        ...
        <div
          class="flex items-center w-full h-full px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
          <svg class="icon w-10 h-10" height="200" p-id="37369" t="1699866701804" version="1.1" viewBox="0 0 1024 1024"
            width="200" xmlns="http://www.w3.org/2000/svg">
            <path
      ...
      <div class="col-span-4 md:col-span-2">
        ...
        <div
          ...
          <h2 class="flex items-center mb-2 font-bold text-gray-600 uppercase dark:text-white">
            <!-- 折线图标 -->
            <svg class="icon w-5 h-5 mr-2" height="200" p-id="58226" t="1699872552774" version="1.1"
