        ...
        <div v-if="tags && tags.length > 0"
          ...
          <div class="flex flex-wrap gap-3">
            <a v-for="(tag, index) in tags" :key="index" @click="goTagArticleListPage(tag.id, tag.name)"
              :class="[route.query.name === tag.name ? 'bg-sky-100 hover:bg-sky-200' : 'hover:bg-gray-100']" class="cursor-pointer inline-flex items-center px-3.5 py-1.5 text-xs font-medium text-center border rounded-[12px]
